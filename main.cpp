...
void loadVideo() {
    if (filmZeStarowki)
        capture.open("/home/dcwik/Pulpit/PeopleCounterOpenCV/videos/[10 sec fragment, HDconvert.com] TownCentreXVID.avi");
    else if (filmZeSkrzyzowaniem)
        capture.open("/home/dcwik/Pulpit/PeopleCounterOpenCV/videos/Video_003.avi");
    else {
