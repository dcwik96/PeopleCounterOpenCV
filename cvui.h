...
// Describe a mouse button
    typedef struct {
        ...
        bool justPressed;           // if the mouse button was just pressed, i.e. true for a start_window_frame when a button is down.
...
namespace internal
{
	...
	void image(cvui_block_t& theBlock, int theX, int theY, cv::Mat& theImage) {
		...
		// TODO: check for render outside the start_window_frame area
